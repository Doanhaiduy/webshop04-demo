    ...
    function activeBuyCourse() {
        buyCourse.classList.toggle('active');
    }
    buttons.forEach(function (button) {
        button.addEventListener('click', activeBuyCourse)
    })

    buyCourse.addEventListener('click', activeBuyCourse)
    buyCourseContainer.addEventListener('click', function (e) {
        e.stopPropagation();
    })
    btnClose.addEventListener('click', activeBuyCourse)
